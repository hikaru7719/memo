...
func request_HealthcheckService_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client HealthcheckServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_HealthcheckService_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, server HealthcheckServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HelloRequest
	var metadata runtime.ServerMetadata
...
func RegisterHealthcheckServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HealthcheckServiceServer) error {
	...
	mux.Handle("POST", pattern_HealthcheckService_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_HealthcheckService_SayHello_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_HealthcheckService_SayHello_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterHealthcheckServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HealthcheckServiceClient) error {
	...
	mux.Handle("POST", pattern_HealthcheckService_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HealthcheckService_SayHello_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_HealthcheckService_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"healthcheck"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_HealthcheckService_SayHello_0 = runtime.ForwardResponseMessage
)
